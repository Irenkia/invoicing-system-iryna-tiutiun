...
describe('AppComponent', () => {
  ...
  it(`newly added company is added to the list`, () => {
    ...
    const addressInput: HTMLInputElement = fixture.nativeElement.querySelector(
      'input[name=address]'
    );
    addressInput.value = 'ul. Third 3';
    addressInput.dispatchEvent(new Event('input'));

    const addInvoiceBtn: HTMLElement =
      fixture.nativeElement.querySelector('#addCompanyBtn');
    addInvoiceBtn.click();

    fixture.detectChanges();

    expect(fixture.nativeElement.innerText).toContain(
      '333-333-33-33	ul. Third 3	Third Ltd.	0	 0'
    );
  });
