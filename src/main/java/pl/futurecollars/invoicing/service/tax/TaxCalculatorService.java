...
public class TaxCalculatorService {
  ...
  public BigDecimal getVatToReturn(String taxIdentificationNumber) {
    return paidVat(taxIdentificationNumber).subtract(paidVat(taxIdentificationNumber));
  }
  ...
  public TaxCalculatorResult calculateTaxes(Company company) {
    ...
    BigDecimal healthInsuranceToSubtract =
        company.getHealthInsurance().multiply(BigDecimal.valueOf(775)).divide(BigDecimal.valueOf(900)).setScale(2, RoundingMode.HALF_UP);
